...
call java -jar JCOV_BUILD\jcov_3.0\jcov.jar tmplgen -verbose -t template.xml -c classes_file.txt %1
start  cmd /c "java -jar JCOV_BUILD\jcov_3.0\jcov.jar grabber -vv -t template.xml -o result\result.xml > grabber_out.txt 2>&1"
pushd %1
